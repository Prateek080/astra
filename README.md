...
> **For teams:** Each developer clones Astra and picks Option A or B. The project-specific files generated by `/astra:init` (`CLAUDE.md`, `.claude/rules/`) get committed to git — that's how the team shares project context.
